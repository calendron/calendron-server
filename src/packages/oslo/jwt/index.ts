import { ECDSA, HMAC, RSASSAPKCS1v1_5, RSASSAPSS } from '../crypto/index';
import { base64url } from '../encoding/index';
import { isWithinExpirationDate } from '../index';

import type { TimeSpan, TypedArray } from '../index';
...
export async function validateJWT(
  ...
  const data = new TextEncoder().encode(
    parsedJWT.parts[0] + '.' + parsedJWT.parts[1]
  );
...
function getAlgorithm(
  algorithm: JWTAlgorithm
): ECDSA | HMAC | RSASSAPKCS1v1_5 | RSASSAPSS {
...
function isValidAlgorithm(
  maybeValidAlgorithm: unknown
): maybeValidAlgorithm is JWTAlgorithm {
